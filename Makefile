...
docker-image-base: base.tar.xz
	unxz base.tar.xz
	docker build -f Dockerfile.base --target base -t archlinux/archlinux:base .

.PHONY: docker-image-base-devel
docker-image-base-devel: base-devel.tar.xz
	unxz base-devel.tar.xz
	docker build -f Dockerfile.base-devel --target base-devel -t archlinux/archlinux:base-devel .
